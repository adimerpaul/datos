...
class PDF extends TCPDF {
  public function Header() {
      ...
      $this->Cell(0, 10, 'Formato IMSS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
  }
}

$pdf = new PDF();
$pdf->AddPage();
contenido($pdf); // Llama a tu función contenido y pasa la instancia de PDF
...
$pdf->AddPage();
contenido($pdf); // Llama a tu función contenido y pasa la instancia de PDF    
$pdf->Output('formulario_imss.pdf', 'I');
    // Mostrar los datos
  ?>
    ...
    <![endif]-->
      ...
      <style>
        ...
        /* Aplicar white-space: nowrap; a las etiquetas label dentro de las divisiones */
        .col-md-1 label,
        .col-xs-1 label {
          white-space: nowrap;
        }
    ...
    <body>
      ...
      <div id="contenedorFormato_1">
        ...
        <div class="row  top-buffer">
          ...
          <div class="col-md-4 col-xs-4 flexbox-container">
            <label>FECHA</label><input readonly type="text" class="inputFormulario text-center" id="fecha_de_alta" name="fecha_de alta" value="<?php echo date("d-m-Y"); ?>" />
          </div>
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-1 col-xs-1 text-left">
              <label style="word-wrap: break-word;">COLONIA:</label>
            </div>
            <div class="col-md-4 col-xs-4 text-center">
          ...
          <div class="row" style="margin-top:50 px;">
            <div class="col-md-9 col-xs-9 text-left">
              <small>
                <label class="small-label">NOTA: SE DEBE ADJUNTAR COPIA DE CREDENCIAL DE ELECTOR Y COMPROBANTE DE DOMICILIO</label>
              </small>
            </div>
            ...
            <div class="col-md-3 col-xs-3 text-right">
              <small><B>
                  ...
                  <label style="position: relative;  bottom: -40px; right:0px;">1A12-009-120</labe>
                </B></small>
            </div>
