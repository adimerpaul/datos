    ...
    <main class="page">
      <div id="contenedorFormato_1" class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-xs-3 text-center">
            <input type="text" class="inputFormulario text-center"  name="estado_nac" id="estado_nac" placeholder="ESTADO" style="display: inline-block;" value="<?php echo $crow['estado']?>"> 
          </div>
          <div class="col-md-3 col-xs-3 text-center">
            <input type="text" class="inputFormulario text-center"  name="ciudad_nac" id="ciudad_nac" placeholder="CIUDAD" style="display: inline-block;" value="<?php echo $crow['municipio']?>"> 
          </div>
          <div class="col-md-1 col-xs-1 ">
            <!-- VACIO -->
          </div>
